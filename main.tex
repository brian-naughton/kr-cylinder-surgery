...
reproducible from the repository accompanying this paper. Any errors that
remain are mine.}\\[2pt]
{\normalsize Independent researcher}\\[1pt]
{\normalsize\texttt{naughtonb@proton.me}}\\[1pt]
{\normalsize ORCID: \href{https://orcid.org/0009-0008-3404-610X}
{0009-0008-3404-610X}}}
...
\begin{sloppypar}
All code, ledgers, and the source of this paper are in the accompanying
repository, \url{https://github.com/brian-naughton/kr-cylinder-surgery},
archived on Zenodo under the concept DOI
\href{https://doi.org/10.5281/zenodo.21745579}{10.5281/zenodo.21745579}, which
resolves to the most recent archived version. The snapshot described here is
release \texttt{v1.0}, commit \texttt{947f096}, archived as
\href{https://doi.org/10.5281/zenodo.21745580}{10.5281/zenodo.21745580}.
Running \texttt{verify.sh} in that repository reproduces every computational
claim from a fresh environment. Corrections and prior-art pointers are
welcome; if any statement here has appeared earlier elsewhere, we will cite it
prominently.
\end{sloppypar}
...
(Anthropic) as described in Appendix~\ref{app:methods}. Any errors that remain
are mine.
